package groupix05.dtnether_update_expanded;
...
@Mod(DynamicTreesNetherUpdateExpanded.MOD_ID)
public final class DynamicTreesNetherUpdateExpanded {

    public static final String MOD_ID = "dtnether_update_expanded";

    public DynamicTreesNetherUpdateExpanded() {
